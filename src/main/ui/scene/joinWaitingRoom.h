...
#ifndef AIREWAR_UI_SCENE_JOINWAITINGROOM_H_
#define AIREWAR_UI_SCENE_JOINWAITINGROOM_H_

#include <string>

namespace airewar::ui::scene {
void joinWaitingRoom(std::u32string address, std::u32string password) noexcept;
}

#endif  // AIREWAR_UI_SCENE_JOINWAITINGROOM_H_
